                          ...
                          <RejectedPaymentBox>
                            <RejectedPaymentHeader>
                              ...
                              <div>
                                ...
                                <RejectedPaymentText>
                                  {paiementRejete.step
                                    ? `Le paiement de la tranche ${paiementRejete.step} n'a pas été validé par notre équipe.`
                                    : "Votre paiement n'a pas été validé par notre équipe."}
                                </RejectedPaymentText>
                              </div>
                            </RejectedPaymentHeader>
                            ...
                            <RejectedPaymentReason>
                              <strong>
                                Motif / commentaire de l'administration
                              </strong>

                              <p>
                                {paiementRejete.adminComment?.trim() ||
                                  paiementRejete.comment?.trim() ||
                                  paiementRejete.reason?.trim() ||
                                  "Aucun commentaire n'a été renseigné."}
                              </p>
                            </RejectedPaymentReason>

                            <RejectedPaymentAction>
                              <span>
                                Vous pouvez effectuer un nouveau paiement.
                              </span>

                              <RepayButton
                                type="button"
                                onClick={() => handleRepay(commande)}
                              >
                                Repayer maintenant
                                <FiArrowRight />
                              </RepayButton>
                          ...
                          <InstallmentPaymentBox>
                            ...
                            {(() => {
                              ...
                              return (
                                ...
                                >
                                  {paiementRejete?.step &&
                                  Number(paiementRejete.step) ===
                                    Number(prochaineTranche.step)
...
const RejectedPaymentTitle = styled.div`
  font-size: 15px;
  font-weight: 800;
`;

const RejectedPaymentText = styled.div`
  margin-top: 5px;
  font-size: 12px;
  line-height: 1.5;
`;
...
const RejectedPaymentAction = styled.div`
  margin-top: 15px;
  display: flex;
  align-items: center;
  justify-content: space-between;
