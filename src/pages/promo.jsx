...
export default function PromoLuxury() {
  ...
  return (
    <PageWrapper>
      ...
      >
        Les promotions sélectionnées offrent des produits d'exception à prix
        avantageux, alliant qualité, style et tendance. Profitez de ces pièces
        uniques pour enrichir votre garde-robe avec élégance, créativité et
        modernité.
      </div>
    </PageWrapper>
  );
