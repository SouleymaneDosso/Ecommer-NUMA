    ...
    <ModalOverlay>
      <ModalContent>
        ...
        <ol>
          ...
          <li>Envoyez le montant total ou en plusieurs étapes depuis votre téléphone.</li>
          <li>
            Récupérez la preuve de paiement : votre <strong>numéro de dépôt</strong>, le <strong>montant envoyé</strong>, et l'<strong>ID unique</strong> généré par Orange/Wave (reçu par SMS ou dans l'application).
          </li>
          <li>Remplissez le formulaire sur notre site avec ces informations.</li>
          <li>Après soumission, un message <strong>“Vérification en cours”</strong> apparaîtra dans votre espace compte.</li>
          <li>Une fois validé, le statut sera mis à jour. Si le paiement est rejeté, le remboursement intégral sera effectué.</li>
        </ol>
    ...
    <Page>
      ...
      <Box>
        ...
        <form onSubmit={handlePaiement}>
          ...
          <Button
            type="submit"
            disabled={commande.paiements.find((p) => p.step === step)?.status === "PAID"}
          >
